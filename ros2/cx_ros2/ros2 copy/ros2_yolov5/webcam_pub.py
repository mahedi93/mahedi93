...
class ImagePublisher(Node):
  ...
  def __init__(self):
    ...
    self.cap = cv2.VideoCapture("file:///home/user/KIMe-Tutorials/ROS2_Yolov5_Docker/Out_Docker/videooo/modelvideo.mp4")
         
    # Used to convert between ROS and OpenCV images
    self.br = CvBridge()
   
    path = '/home/user/KIMe-Tutorials/ROS2_Yolov5_Docker/In_Docker/y5.pt'
  ...
  def timer_callback(self):
    ...
    if ret == True:
      ...
      ########
      #cv2.imshow("yolov5 processed camera", processed_image.ims[0])
      #cv2.waitKey(1)
      ########
    else:
